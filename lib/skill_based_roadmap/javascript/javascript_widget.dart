...
import 'javascript_model.dart';
export 'javascript_model.dart';

class JavascriptWidget extends StatefulWidget {
  const JavascriptWidget({super.key});
...
class _JavascriptWidgetState extends State<JavascriptWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavascriptModel());
